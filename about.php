                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="team-member">
                                ...
                                <!-- Name -->
                                <h4>Akshay Anand</h4>
                                <span class="deg">Co-owner & Backend Engineer</span>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <!-- Team Member -->
                            <div class="team-member">
                                ...
                                <!-- Name -->
                                <h4>Prashansa Agarwal</h4>
                                <span class="deg">Co-owner & Frontend Engineer</span>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <!-- Team Member -->
                            <div class="team-member">
                                ...
                                <!-- Name -->
                                <h4>Supriya Kumari</h4>
                                <span class="deg">Co-owner & Database Admin</span>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <!-- Team Member -->
                            <div class="team-member">
                                ...
                                <!-- Name -->
                                <h4>Anshu Raj</h4>
                                <span class="deg">Co-owner & Manager</span>
                            </div>
                        </div>
                    </div>
                </div>
